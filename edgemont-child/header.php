...
<html <?php language_attributes();?>>
	...
	<body>
		...
		<header id="mainHeader">
			...
			<h1>Edgemont Elementary School</h1>
			</a>
				<aside>
					<ul class="sociallinks">
						...
						<li><a href="https://twitter.com/@edgemonteagle"><img src="<?php echo get_template_directory_uri() .'/assets/icons/socialmedia-twitter-white.svg' ?>" alt="Link to Twitter" /></span>
							</a>
						</li>
						<li><a href="https://www.facebook.com/EdgemontElementary"><img src="<?php echo get_template_directory_uri() .'/assets/icons/socialmedia-facebook-white.svg' ?>" alt="Link to Facebook" /></span>
							</a>
						</li>
					</ul>
					<!-- Search Form -->
					...
					<ul class="contactinfo" itemscope itemtype="https://schema.org/PostalAddress">
						<li><span itemprop="streetAddress">566 East 3650 North</span><span itemprop="addressLocality"> Provo</span>, <span itemprop="addressRegion">Utah</span> <span itemprop="postalCode">84604</span><span class="phone" itemprop="telephone"> Phone: (801) 221-9984</span><span class="fax" itemprop="faxNumber"> Fax: (801) 221-9987</span>
					</ul>
